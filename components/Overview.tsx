      ...
      <div id="ovgrid">
        ...
        <div className="ovcol">
          ...
          >
            ...
            <div style={css('display:flex;flex-direction:column;gap:18px;align-items:flex-start')}>
              <div style={css('width:100%;display:flex;gap:16px;align-items:flex-start')}>
              ...
              <div style={css('width:100%;max-width:340px')}>
        ...
        <div className="ovcol">
          ...
          {/* 03 HABITS */}
          <section
            style={css('background:var(--panel);border:1px solid var(--line);border-radius:16px;padding:15px 17px')}
          >
